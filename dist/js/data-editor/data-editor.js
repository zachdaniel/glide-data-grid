...
var DataEditor = function DataEditor(p) {
  ...
  var onMouseDown = React.useCallback(function (args) {
    ...
    if (args.kind === "cell") {
      ...
      if (col === 0 && rowMarkers) {
        ...
        var _index = selectedRows.indexOf(row);

        if (_index !== -1) {
          setSelectedRows((0, _support.removeArrayItem)(selectedRows, _index));
        } else {
          setSelectedRows([].concat(_toConsumableArray(selectedRows), [row]));
        }
      } else {
        if ((gridSelection === null || gridSelection === void 0 ? void 0 : gridSelection.cell[0]) !== col || gridSelection.cell[1] !== row) {
          if (args.shiftKey && gridSelection !== undefined) {
            ...
            var top = Math.min(row, sRow);
            var bottom = Math.max(row, sRow);
  ...
  var onItemHoveredImpl = React.useCallback(function (args) {
    ...
    if (mouseState.current !== undefined && gridSelection !== undefined && !isDraggable) {
      ...
      var deltaY = (row !== null && row !== void 0 ? row : 0) - selectedRow;
      var newRange = {
  ...
  var onKeyDown = React.useCallback(function (event) {
    var fn = /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var shiftKey, isDeleteKey, isCopyKey, _gridSelection$cell6, _col2, _row, cellValue, cells, _gridSelection$cell7, col, row, text, _cellValue, _cellValue2, del, _cell2, key, moved;
              ...
              case 13:
                if (isCopyKey && getCellsForSelection !== undefined) {
                  if (gridSelection !== undefined) {
                    _gridSelection$cell6 = _slicedToArray(gridSelection.cell, 2), _col2 = _gridSelection$cell6[0], _row = _gridSelection$cell6[1];
                    ...
                    if (gridSelection.range !== undefined && getCellsForSelection !== undefined) {
                      ...
                      cellValue = getCellContent([_col2 - rowMarkerOffset, _row]);
