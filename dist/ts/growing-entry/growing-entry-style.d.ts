...
export declare const ShadowBox: import("styled-components").StyledComponent<"div", {
    overlayName: string;
    darkGrey: string;
    fgColorDarkest: string;
    fgColorDark: string;
...
export declare const GrowingEntryStyle: import("styled-components").StyledComponent<"div", {
    overlayName: string;
    darkGrey: string;
    fgColorDarkest: string;
    fgColorDark: string;
